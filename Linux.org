...
* yes(1)
  ...
  Of course, not all prompts require or accept ~y/n~, that is why you can provide arbitrary string(s) when invoking yes commands and they will be used instead of 'y'.
